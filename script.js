...
const domain = 'https://portal.ifba.edu.br/';
const storageKey = '@IFBASavePost';

const savePostMessages = {
    'default': '<i class="fa-solid fa-plus"></i> Salvar notícias',
    'added': '<i class="fa-regular fa-bookmark"></i> Post salvo',
    'out': 'Você não está na pagína de notícias',
};
...
async function main() {
    ...
    const regex = /https:\/\/portal.ifba.edu.br.ilheus\/([A-Za-z0-9-_]+)\/([A-Za-z0-9-_]+)/;
    const isIFBAPost = regex.test(tab.url);
